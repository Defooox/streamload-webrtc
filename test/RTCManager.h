...
#include <absl/types/optional.h> // FIX: Добавлен заголовок для absl::optional
#include <memory>
#include <string>
#include <functional>
#include <map>
...
private:
    ...
    public:
        ...
        // Обязательные переопределения для AdaptedVideoTrackSource
        bool is_screencast() const override { return false; }
        absl::optional<bool> needs_denoising() const override { return false; }

    protected:
        // FIX: Деструктор должен быть protected для ref-counted объектов
